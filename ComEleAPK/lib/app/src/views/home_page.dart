    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'RUFF BOOKING',
          style: TextStyle(
              fontFamily: 'FirSans', fontSize: 22.0, color: Colors.black),
        ),
        centerTitle: true,
        leading: IconButton(
        ...
        children: [
          ...
          Container(
              ...
              child: ListView(
                ...
                scrollDirection: Axis.horizontal,
                children: [
                  getBarber('assets/corte1.jpg', 'UNDERCUT'),
                  SizedBox(
                    width: 15.0,
                  ),
                  ...
                  getBarber('assets/corte3.jpg', 'QUIFF'),
                  SizedBox(
                    width: 15.0,
                  ),
                  getBarber('assets/corte4.jpg', 'FADE'),
                  SizedBox(
                    width: 15.0,
                  ),
                  getBarber('assets/corte5.jpg', 'POMPADOUR'),
                  SizedBox(
                    width: 15.0,
                  ),
                  getBarber('assets/corte6.jpg', 'EXECUTIVE'),
                  SizedBox(
                    width: 15.0,
                  ),
                  getBarber('assets/corte7.jpg', 'SCUMBAG'),
                  SizedBox(
                    width: 15.0,
                  ),
                ],
          ...
          Row(
            children: [
              ...
              getService('Servicios Ruffians', 12),
              getService('Ruffians',7),
            ],
          )
        ],
      ),
